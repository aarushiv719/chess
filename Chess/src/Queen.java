 ...
 * Includes string name "wQ" if it belongs to the white team
 * Includes string name "bQ" if it belongs to the black team
 *
...
public class Queen extends Piece {
    /**
     * Queen constructor, initializes Queen referencing superclass Piece
